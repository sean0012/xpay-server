...
router.get('/status',
	...
	async (req, res) => {
		...
		res.json({
			...
			collateral_amount: req.user.collateral_amount ? req.user.collateral_amount.toString() : undefined,
			collateral_price: price ? price.toString() : undefined,
			collateral: collateralValue ? collateralValue.toString() : undefined,
			collateral_balance: req.user.collateral_balance ? req.user.collateral_balance.toString() : undefined,
			...
			points: req.user.points ? req.user.points.toString() : undefined,
			grade: req.user.grade ? req.user.grade.toString() : undefined,
			user_type: req.user.user_type,
			first_name: req.user.first_name,
			last_name: req.user.last_name,
			merchant_name: req.user.merchant_name,
			withdrawable: req.user.withdrawable ? req.user.withdrawable.toString() : undefined,
			deposit: req.user.deposit ? req.user.deposit.toString() : undefined,
			payment_date: new Date(paymentDate).getTime(),
			payment_now: req.user.payment_thismonth ? req.user.payment_thismonth.toString() : undefined,
